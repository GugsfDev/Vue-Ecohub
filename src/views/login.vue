  ...
  <div class="split-layout">
          ...
          <form @submit.prevent="fazerLogin">
            <div class="grupo-input">
              ...
              <div class="campo">
                ...
                <input type="email" v-model="email" placeholder="seu.email@eniac.edu.br" required>
              </div>
            </div>
    ...
    <div class="image-side">
      <div class="image-content">
        ...
        <p>Compartilhe seus projetos, participe de eventos e conecte-se com a comunidade de inovação da Eniac.</p>
...
const mostrarSenha = ref(false) // Controla o olhinho da senha

const fazerLogin = () => {
  console.log('Pronto para enviar para a API:', email.value, senha.value)
}
</script>

<style scoped>
/* Puxa o seu CSS original! Se não carregar a imagem de fundo, 
   verifique o caminho url('../img/eniac.jpg') lá dentro do login_cadastro.css */
